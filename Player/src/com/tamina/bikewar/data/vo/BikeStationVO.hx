...
class BikeStationVO {
    ...
    public function new(id:String,name:String,numSlot:String,latitude:String,longitude:String,type:String,CB:String,zone:String,riveDroite:String,rocade:String) {
        this.id = id;
        this.name = name;
